...
- Async SQLModel/SQLAlchemy engine
...
from app.models import Conversation, Priority, Task, User  # noqa: F401
...
# We import settings here to get the URL from .env
from app.core.config import settings  # noqa: E402

# Convert async URL format if needed (asyncpg)
