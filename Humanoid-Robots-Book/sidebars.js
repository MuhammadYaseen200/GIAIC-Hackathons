...
const sidebars = {
  tutorialSidebar: [
    'intro',
    {
      ...
      items: [
        'module-1-ros2-basics/chapter-1-intro',
        'module-1-ros2-basics/chapter-2-pub-sub',
        'module-1-ros2-basics/chapter-3-services-actions',
        'module-1-ros2-basics/chapter-4-nervous-system',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'module-2-digital-twin/chapter-5-digital-twin-intro',
        'module-2-digital-twin/chapter-6-urdf-modeling',
        'module-2-digital-twin/chapter-7-gazebo-simulation',
      ],
    },
    // --- COMMENTED OUT FUTURE MODULES (Uncomment when you create the files) ---
    /*
    {
      type: 'category',
      label: 'Module 3: Physical Intelligence',
      items: [
        'module-3-isaac/chapter-8-isaac-gym-intro',
        'module-3-isaac/chapter-9-rl-training',
        'module-3-isaac/chapter-10-sim-to-real',
      ],
    },
    {
      type: 'category',
      label: 'Module 4: VLA & Deployment',
      items: [
        'module-4-vla/chapter-11-vla-intro',
        'module-4-vla/chapter-12-multimodal-integration',
        'module-4-vla/chapter-13-deployment',
      ],
    },
    {
      type: 'category',
